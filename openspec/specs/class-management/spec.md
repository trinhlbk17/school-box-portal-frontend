...
### Requirement: Students tab renders StudentListTab
The system SHALL render the `StudentListTab` component in the Students tab of ClassDetailPage. The Albums tab SHALL continue to render a placeholder EmptyState until Phase 5.
